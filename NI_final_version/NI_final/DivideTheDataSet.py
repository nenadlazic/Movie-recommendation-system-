...
dataset_file = "ClusteredData/clustered_data.csv"
...
def divide_dataset(test_percentage = 30):
    ...
    print("Trening instance su upisane u fajl TrainingSet/training.csv")
    test.to_csv(TEST_SET, sep=',', index=False)
    print("Test instance su upisane u fajl TestSet/test.csv")
